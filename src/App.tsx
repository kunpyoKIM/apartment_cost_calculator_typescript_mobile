...
export default function App() {
  ...
  const calc = useMemo(() => {
    ...
    const sharedMarkup = 1.12;
    const apartmentMinSale = (appliedBaseRate + appliedBaseRate * 0.5 + landUnitCost) * sharedMarkup;
    const officetelMinSale = (appliedBaseRate * 1.25 + landUnitCost) * sharedMarkup;
    const retailMinSale = (appliedBaseRate * 1.25 + landUnitCost) * sharedMarkup;
